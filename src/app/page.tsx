  ...
  return (
    <div className="flex flex-col justify-between h-screen bg-gray-800 p-2 mx-auto max-w-full">
      ...
      <button
        onClick={() => {
          window.open(
            "https://github.com/kevenson/codebase-assistant",
            "_blank"
          );
        }}
